;;; bioma-theme.el --- Theme using Template SCSS variables -*- lexical-binding: t -*-
...
(deftheme bioma "Theme using Template variables with quality of life improvements.")
